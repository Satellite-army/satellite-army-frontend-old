    ...
    <Card style={{marginBottom:"10px"}}>
      <div className="deposit-header" style={{ display: "flex" }}>
        <div style={{ flexShrink: "unset" }}>
          <Row>
            <Col span="3"><TokenIcon style={{ marginLeft: 10, marginRight: 20 }} mintAddress={props.props.mint1} /><TokenIcon mintAddress={props.props.mint2} /></Col>
            ...
            <Col span="4" style={{ textAlign: "left" }}>First deposit: {props.props.firstDeposit}</Col>
          </Row>
          <Row>
            <Col span="3" style={{ textAlign: "left" }}>{props.props.token1} / {props.props.token2}</Col>
            <Col span="4" style={{ textAlign: "left" }}><Popover content={lpTokenPop} title="Single LP token price" trigger="hover">{props.props.lpNumber} / {props.props.lpTotalValue} $</Popover></Col>
            <Col span="4" style={{ textAlign: "left" }}>From last deposit / withdrawal</Col>
            <Col span="4" style={{ textAlign: "left" }}>{props.props.ILPercentage}% / {props.props.ILDollar} $</Col>
          ...
          <Row>
            ...
            <Col span="4" style={{ textAlign: "left" }}>{props.props.last}</Col>
          ...
          <Row>
            <Col span="3" style={{ textAlign: "left" }}>
              <a href={props.props.liquidityLink}>Add liquidity</a>
            </Col>
            <Col span="4" style={{ textAlign: "left" }}>{props.props.distribution1} / {props.props.distribution2}</Col>
            ...
            <Col span="4" style={{ textAlign: "left" }}>{props.props.optimal} time a day</Col>
